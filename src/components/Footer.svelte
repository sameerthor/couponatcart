    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
                ...
                <div class="block about">
                    <a class="navbarBrand" href="/">
                        <h3 class="">CouponAtCart</h3>
                    </a>
                    <p class="alt-color siteText">CouponAtCart is a perfect destination to get Coupon Codes, Promo Codes, and
            ...
            <div class="col-lg-2 col-md-3 offset-md-1 offset-lg-0">
                <div class="block footerBlock">
                    <h4 class="footerHeading">Get Help</h4>
                    <ul class="footerUl">
            ...
            <div class="col-lg-4 col-md-7 te">
                <div class="block footerBlock">
                    <h4 class="footerHeading">Keep Update</h4>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control emailInput" placeholder="Your Email..."
                            ...
                            style="border-radius: 0!important; height: 43px;">
                        <div class="input-group-append">
                            <button class="btn  footerBtn" type="button" id="button-addon2"
...
<style>
    ...
    .footerBlock .footerUl{
       margin: 0px !important;
       padding: 0rem;
    }
    .footerBlock .footerUl li{
       margin-bottom: .2rem;
    }
    .footerBlock .footerUl li a{
      text-decoration: none;
      letter-spacing: .5px;
    }
    .siteText{
